...
import { FileText, Download, AlertCircle, CheckCircle, Truck, Briefcase, Calculator, Users, Scale, Wrench, Calendar, MapPin, Clock, Building2, ExternalLink, Mail, Phone, ArrowRight, Settings, Wallet } from "lucide-react";
            ...
            <div className="flex items-center justify-between p-6 bg-gradient-to-r from-gray-900/90 to-slate-800/90 backdrop-blur-xl border-b border-white/10">
              <div className="flex items-center space-x-4">
                ...
                <div className="text-white/90 font-medium">
                  <span dangerouslySetInnerHTML={{ __html: cleanHtml(data.catalogueFormation.title) }} />
                  {' - '}
                  <span dangerouslySetInnerHTML={{ __html: cleanHtml(data.catalogueFormation.description) }} />
                </div>
              </div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-20 relative overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-40 -right-40 w-80 h-80 bg-emerald-500/10 rounded-full blur-3xl animate-pulse" />
            <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-teal-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              <h2 className="text-4xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-white via-emerald-100 to-teal-100 bg-clip-text text-transparent">
                  {data.commerceFormation.cta.title}
                </span>
              </h2>
              <p className="text-lg mb-8 max-w-3xl mx-auto text-emerald-100/90 leading-relaxed">
                {data.commerceFormation.cta.description}
              </p>
              <Button asChild className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
                <Link to="/contact" className="flex items-center">
                  {data.commerceFormation.cta.buttonText}
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            </div>
        ...
        <div className="bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              <h2 className="text-4xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-white via-emerald-100 to-teal-100 bg-clip-text text-transparent">
                  {data.conduiteFormation.cta.title}
                </span>
              </h2>
              <p className="text-lg mb-8 max-w-3xl mx-auto text-emerald-100/90 leading-relaxed">
              ...
              <Button asChild className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
                <Link to="/contact" className="flex items-center">
                  {data.conduiteFormation.cta.buttonText}
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                  <span className="bg-gradient-to-r from-white via-emerald-100 to-teal-100 bg-clip-text text-transparent">
                    {data.diagnosticFormation.title}
                  </span>
                </h1>
                <p className="text-lg text-emerald-100/90 mb-8 leading-relaxed">
        ...
        <div className="bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              <h2 className="text-4xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-white via-emerald-100 to-teal-100 bg-clip-text text-transparent">
                  {data.diagnosticFormation.cta.title}
                </span>
              </h2>
              <p className="text-lg mb-8 max-w-3xl mx-auto text-emerald-100/90 leading-relaxed">
              ...
              <Button asChild className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
                <Link to="/contact" className="flex items-center">
                  {data.diagnosticFormation.cta.buttonText}
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            </div>
...
export const Evenements = () => {
  ...
  // Ajout du check de chargement
  if (!datapJson.evenements) {
    return <div className="min-h-screen flex items-center justify-center text-gray-500 text-xl">Chargement...</div>;
  }
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <div className="bg-gray-50 py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">{datapJson.evenements.title}</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-actl-light-green rounded-lg overflow-hidden shadow-lg">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8">
                <Badge className="bg-actl-green hover:bg-actl-green/90 mb-4">Événement phare</Badge>
                <h2 className="text-2xl font-bold text-gray-800 mb-4">{events[0]?.title}</h2>
                ...
                <Button asChild className="bg-actl-green hover:bg-actl-green/90">
                  <Link to="/contact">S'inscrire à l'événement</Link>
                </Button>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-6">
                {data.evenements.calendar.map((event, index) => (
        ...
        <div className="bg-actl-green text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold mb-4">{data.evenements.cta.title}</h2>
              <p className="text-lg mb-8 max-w-2xl mx-auto">
                {data.evenements.cta.description}
              </p>
              <Button asChild className="bg-white text-actl-green hover:bg-gray-100">
                <Link to="/contact">{data.evenements.cta.buttonText}</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              <h2 className="text-4xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-white via-emerald-100 to-teal-100 bg-clip-text text-transparent">
                  {data.financeFormation.cta.title}
                </span>
              </h2>
              <p className="text-lg mb-8 max-w-3xl mx-auto text-emerald-100/90 leading-relaxed">
              ...
              <Button asChild className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
                <Link to="/contact" className="flex items-center">
                  {data.financeFormation.cta.buttonText}
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            </div>
...
export const MecaniqueFormation = () => {
  const { datapJson } = useDashboardStore();
  const data = datapJson?.mecaniqueFormation;

  if (!data) return <div>Formation non trouvée.</div>;
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <Card className="group overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <ul className="space-y-3">
                  {data.programStructure?.map((item: string, index: number) => (
                    <li key={index} className="flex items-start group/item">
                      <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3 mt-2 group-hover/item:scale-125 transition-transform duration-200" />
                      <span className="text-gray-600 leading-relaxed">{item}</span>
                    </li>
            ...
            <Card className="group overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <ul className="space-y-3">
                  {data.courseContent?.map((item: string, index: number) => (
                    <li key={index} className="flex items-start group/item">
                      <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3 mt-2 group-hover/item:scale-125 transition-transform duration-200" />
                      <span className="text-gray-600 leading-relaxed">{item}</span>
                    </li>
            ...
            <Card className="group overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <ul className="space-y-3">
                  {data.careerOpportunities?.map((item: string, index: number) => (
                    <li key={index} className="flex items-start group/item">
                      <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3 mt-2 group-hover/item:scale-125 transition-transform duration-200" />
                      <span className="text-gray-600 leading-relaxed">{item}</span>
                    </li>
        ...
        <div className="bg-gray-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="section-title text-center mx-auto">{data.workshopTitle}</h2>
            <p className="text-center text-gray-600 max-w-2xl mx-auto mb-8">
              {data.workshopDescription}
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
              {data.workshopImages?.map((image: string, index: number) => (
                <img
                  key={index}
                  src={image}
                  alt={`Atelier ${index + 1}`}
        ...
        <div className="bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              <h2 className="text-4xl font-bold mb-6 leading-tight">
                <span className="bg-gradient-to-r from-white via-emerald-100 to-teal-100 bg-clip-text text-transparent">
                  {data.cta?.title || "Prêt à lancer votre carrière en mécanique automobile ?"}
                </span>
              </h2>
              <p className="text-lg mb-8 max-w-3xl mx-auto text-emerald-100/90 leading-relaxed">
                {data.cta?.description || "Inscrivez-vous dès maintenant à notre formation complète et développez des compétences recherchées dans le secteur automobile."}
              </p>
              <Button asChild className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
                <Link to="/contact" className="flex items-center">
                  {data.cta?.buttonText || "S'inscrire maintenant"}
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            </div>
      ...
      <main className="flex-grow">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Développez vos compétences en ressources humaines avec une formation complète et pratique.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <Card className="group overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm">
        ...
        <div className="bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              ...
              <Button asChild className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
                <Link to="/contact" className="flex items-center">
                  {data.rhFormation.cta.buttonText}
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            </div>
